...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 23:06:54 2020
...
def modelRGBD():
    ...
    conv_layer1 = Conv2D(16, (3,3))(inp_RGB)
    conv_layer2 = Conv2D(16, (3,3))(conv_layer1)
    conv_layer3 = Conv2D(16, (3,3), strides=(1, 1), padding='valid', activation='relu')(conv_layer2)
    BN_1 = BatchNormalization()(conv_layer3)
    #pool_layer1 = MaxPooling2D(pool_size=(2, 2), strides=(2,2), padding='valid')(BN_1)
    dropout1 = Dropout(0.3)(BN_1)
    
    
    conv_layer4 =Conv2D(64, (3,3), strides=(1, 1), padding='valid', activation='relu')(dropout1)
    ...
    conv_layer6 = Conv2D(128, (3,3), strides=(1, 1), padding='valid', activation='relu')(dropout2)
    BN_3 = BatchNormalization()(conv_layer6)
    ...
    conv_layer1_2 = Conv2D(16, (3,3))(inp_D)
    conv_layer2_2 = Conv2D(16, (3,3))(conv_layer1_2)
    conv_layer3_2 = Conv2D(16, (3,3), strides=(1, 1), padding='valid', activation='relu')(conv_layer2_2)
    BN_1_2 = BatchNormalization()(conv_layer3_2)
    #pool_layer1_2 = MaxPooling2D(pool_size=(2, 2), strides=(2,2), padding='valid')(BN_1_2)
    dropout1_2 = Dropout(0.3)(BN_1_2)
    
    
    conv_layer4_2 =Conv2D(32, (3,3), strides=(1, 1), padding='valid', activation='relu')(dropout1_2)
    conv_layer5_2 = Conv2D(32, (3,3), strides=(1, 1), padding='valid', activation='relu')(conv_layer4_2)
    BN_2_2 = BatchNormalization()(conv_layer5_2)
    pool_layer2_2 = MaxPooling2D(pool_size=(2, 2), strides=(2,2), padding='valid')(BN_2_2)
    dropout2_2 = Dropout(0.3)(pool_layer2_2)
    
    
    
    conv_layer6_2 = Conv2D(64, (3,3), strides=(1, 1), padding='valid', activation='relu')(dropout2_2)
    BN_3_2 = BatchNormalization()(conv_layer6_2)
    ...
    hidden1_2 = Dense(2048, activation = 'relu')(flatten_layer_2)
...
model = modelRGBD()
history=model.fit([X_train,X_train_D], y_train, batch_size=64, epochs=100, validation_data=([X_test, X_test_D],y_test))
